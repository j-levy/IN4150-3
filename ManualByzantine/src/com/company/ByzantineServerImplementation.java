...
public class ByzantineServerImplementation implements ByzantineServerInterface {
    ...
    public ByzantineServerImplementation(int remoteN, int f, int remoteID, boolean remoteIsTraitor, byte remoteFailureType, int remoteValue) throws RemoteException, NotBoundException, MalformedURLException {
